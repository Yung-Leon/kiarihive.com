...
$totalRevenue = $conn->query("SELECT SUM(total) FROM orders WHERE status='approved'")->fetchColumn();
...
<head>
<meta charset="UTF-8">
<title>Reports - KiariHive Admin</title>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3">
                    <div class="card p-3 shadow-sm">
                        ...
                        <h2><?= $totalRevenue ? number_format($totalRevenue) : 0 ?></h2>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card p-3 shadow-sm">
